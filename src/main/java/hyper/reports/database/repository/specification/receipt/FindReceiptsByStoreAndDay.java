...
public class FindReceiptsByStoreAndDay implements Specification<Receipt> {
  ...
  public FindReceiptsByStoreAndDay(int storeId, int month, int day, int year) {
    ...
    try (Connection connection = HikariCPDataSource.getConnection();
      ...
      String sql =
          create
              ...
              .and(day(RECEIPT.DATE_TIME).eq(day))
